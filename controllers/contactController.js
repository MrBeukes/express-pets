...
exports.submitContact = async function (req, res, next) {
  ...
  try {
    ...
    <p>We appreciate your interest in ${doesPetExist.name} and one of our staff members will reach out to you shortly! Below is a copy you sent us for your personal records:</p>
